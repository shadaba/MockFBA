...
function Assign_xy_zone(xfocal,yfocal,fp_bound)
    ...
    zone_x=zeros(Int32,nobj)
    zone_y=zeros(Int32,nobj)
    
    @. zone_x = floor(Int32,(xfocal-fp_bound.xmin)/fp_bound.dx_zone)
    @. zone_y = floor(Int32,(yfocal-fp_bound.ymin)/fp_bound.dy_zone)
